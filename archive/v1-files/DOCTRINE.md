...
|----------|---------|---------|
| **ARCHITECTURE.md** | CTB Constitutional Law (CTB, CC, Hub-Spoke, IMO, Descent, PID) | 2.1.0 |
| **TOOLS.md** | Tool doctrine — determinism first, LLM as tail | 1.1.0 |
| **OSAM.md** | Query routing contract — table ownership, joins, HALT conditions | 1.1.0 |
| **SNAP_ON_TOOLBOX.yaml** | Master tool registry — approved tools, banned list | 1.0.0 |
| **CC_OPERATIONAL_DIGEST.md** | Extracted operational rules (TIER 1 loading) | 1.0.0 |

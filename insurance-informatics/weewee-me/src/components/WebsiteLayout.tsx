...
export function WebsiteLayout({ page }: WebsiteLayoutProps) {
  const communicationId = 'WEB-WEEWEE-HOME';
    ...
    <div className="website">
      ...
      <section className="hero">
        <div className="hero-inner">
          ...
          <img src="/logos/weewee-me-logo.jpg" alt="WeeWee.Me" className="hero-logo" />
      ...
      <footer className="site-footer">
        <div className="footer-inner">
          <div className="footer-brand">
            <strong>WeeWee.Me</strong>
            <p>Automation, Explained for Leadership</p>
          </div>
